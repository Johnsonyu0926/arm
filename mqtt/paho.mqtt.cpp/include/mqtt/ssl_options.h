...
private:
	...
	/** The file containing the public digital certificates trusted by the client. */
	string trustStore_;
...
public:
	 ...
	 * @param trustStore The file containing the public digital certificates trusted by the client.
	 * @param keyStore The file containing the public certificate chain of the client.
	 * @param privateKey The file containing the client's private key.
	 * @param privateKeyPassword The password to load the client's privateKey if encrypted.
	 * @param enabledCipherSuites The list of cipher suites that the client will present to the server during the SSL handshake.
	 * @param enableServerCertAuth True/False option to enable verification of the server certificate
