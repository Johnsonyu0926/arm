...
create_group7_command = {
    'commands': [{'command': 'createGroup', 'groupname': 'group', 'roles': [{'rolename': 'notfound'}]}]}
...
remove_client7_command = {
    'commands': [{'command': 'removeGroupClient', 'groupname': 'notfound', 'username': 'validclient'}]}
remove_client7_response = {'responses': [{'command': 'removeGroupClient', 'error': 'Group not found'}]}

# Client not found
remove_client8_command = {
    'commands': [{'command': 'removeGroupClient', 'groupname': 'validgroup', 'username': 'notfound'}]}
...
modify_group4_command = {
    'commands': [{'command': 'modifyGroup', 'groupname': 'validgroup', 'password': 'test', 'roles': 'string'}]}
modify_group4_response = {
    'responses': [{'command': 'modifyGroup', 'error': "'roles' not an array or missing/invalid rolename"}]}
...
modify_group6_command = {
    'commands': [{'command': 'modifyGroup', 'groupname': 'validgroup', 'roles': [{'rolename': 5}]}]}
...
modify_group9_command = {
    'commands': [{'command': 'modifyGroup', 'groupname': 'validgroup', 'roles': [{'rolename': 'notfound'}]}]}
