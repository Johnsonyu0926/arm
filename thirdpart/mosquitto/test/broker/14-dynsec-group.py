...
create_group_repeat_response = {
    'responses': [{"command": "createGroup", "error": "Group already exists", "correlationData": "3"}]}
...
list_groups_response = {'responses': [
    {"command": "listGroups", "data": {"totalCount": 2, "groups": ["group_one", "group_two"]},
     "correlationData": "10"}]}
...
add_duplicate_client_to_group_response = {
    'responses': [{'command': 'addGroupClient', 'error': 'Client is already in this group', 'correlationData': '1234'}]}
