...
static void erratum_rcw_src(void)
{
    ...
    uint32_t __iomem *dcfg_ccsr = (uint32_t __iomem *)DCFG_BASE;
    uint32_t __iomem *dcfg_dcsr = (uint32_t __iomem *)DCFG_DCSR_BASE;
    uint32_t val;
...
static void erratum_a009203(void)
{
    ...
    ptr = (uint8_t __iomem *)(I2C1_BASE_ADDR + I2C_DEBUG_REG);

    writeb(I2C_GLITCH_EN, ptr);
#endif
#ifdef I2C2_BASE_ADDR
    ptr = (uint8_t __iomem *)(I2C2_BASE_ADDR + I2C_DEBUG_REG);

    writeb(I2C_GLITCH_EN, ptr);
#endif
#ifdef I2C3_BASE_ADDR
    ptr = (uint8_t __iomem *)(I2C3_BASE_ADDR + I2C_DEBUG_REG);

    writeb(I2C_GLITCH_EN, ptr);
#endif
#ifdef I2C4_BASE_ADDR
    ptr = (uint8_t __iomem *)(I2C4_BASE_ADDR + I2C_DEBUG_REG);
...
static void erratum_a009929(void)
{
    ...
    uint32_t __iomem *dcsr_cop_ccp = (void *)CONFIG_SYS_DCSR_COP_CCP_ADDR;
    uint32_t rstrqmr1 = gur_in32(&gur->rstrqmr1);
 ...
 */
#if defined(CONFIG_SYS_FSL_ERRATUM_A009660) && defined(CONFIG_SYS_FSL_ERRATUM_A008514)
...
static void erratum_a009660(void)
{
    ...
    uint32_t *eddrtqcr1 = (void *)CONFIG_SYS_FSL_SCFG_ADDR + 0x20c;
...
static void erratum_a010539(void)
{
    ...
    out_be32((void *)(CONFIG_SYS_DCSR_DCFG_ADDR + DCFG_DCSR_PORCR1), porsr1);
#endif
}
...
int get_core_volt_from_fuse(void)
{
    ...
    debug("%s: fusesr = 0x%x\n", __func__, fusesr);
    vid = (fusesr >> FSL_CHASSIS2_DCFG_FUSESR_ALTVID_SHIFT) & FSL_CHASSIS2_DCFG_FUSESR_ALTVID_MASK;
    if ((vid == 0) || (vid == FSL_CHASSIS2_DCFG_FUSESR_ALTVID_MASK)) {
        vid = (fusesr >> FSL_CHASSIS2_DCFG_FUSESR_VID_SHIFT) & FSL_CHASSIS2_DCFG_FUSESR_VID_MASK;
    }
    debug("%s: VID = 0x%x\n", __func__, vid);
    switch (vid) {
...
__weak int board_switch_core_volt(uint32_t vdd)
{
    return 0;
}

static int setup_core_volt(uint32_t vdd)
{
...
{
    uint32_t *qspi_lut, lut_key, *qspi_key;
