...
{ 
 ...
 struct ccsr_clk_ctrl __iomem *clk_ctrl = (void *)(CONFIG_SYS_FSL_CH3_CLK_CTRL_ADDR); 
 unsigned int cpu; 
 const uint8_t core_cplx_pll[16] = { 
 [0] = 0, [1] = 0, [2] = 0, [4] = 1, [5] = 1, [6] = 1, 
 [8] = 2, [9] = 2, [10] = 2, [12] = 3, [13] = 3, [14] = 3 
 }; 
 
 const uint8_t core_cplx_pll_div[16] = { 
 [0] = 1, [1] = 2, [2] = 4, [4] = 1, [5] = 2, [6] = 4, 
 [8] = 1, [9] = 2, [10] = 4, [12] = 1, [13] = 2, [14] = 4 
 }; 
 ...
 sys_info->freq_systembus *= (gur_in32(&gur->rcwsr[0]) >> FSL_CHASSIS3_RCWSR0_SYS_PLL_RAT_SHIFT) & FSL_CHASSIS3_RCWSR0_SYS_PLL_RAT_MASK; 
 sys_info->freq_ddrbus *= (gur_in32(&gur->rcwsr[0]) >> FSL_CHASSIS3_RCWSR0_MEM_PLL_RAT_SHIFT) & FSL_CHASSIS3_RCWSR0_MEM_PLL_RAT_MASK; 
#ifdef CONFIG_SYS_FSL_HAS_DP_DDR 
 if (soc_has_dp_ddr()) { 
 ...
 offset = (void *)((size_t)clk_grp[i / 3] + offsetof(struct ccsr_clk_cluster_group, pllngsr[i % 3].gsr)); 
 ...
 c_pll_sel = (in_le32(&clk_ctrl->clkcncsr[cluster].csr) >> 27) & 0xf; 
