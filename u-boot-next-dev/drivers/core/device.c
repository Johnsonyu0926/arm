...
/**
 * @brief Common function for binding a device
 *
 * @param parent Parent device
 * @param drv Driver
 * @param name Device name
 * @param platdata Platform data
 * @param driver_data Driver data
 * @param node Device tree node
 * @param of_platdata_size Size of platform data from device tree
			      ...
			      uint of_platdata_size, struct udevice **devp)
{
	...
	if (gd->flags & GD_FLG_RELOC) {
		...
		if (drv->id == UCLASS_MMC || drv->id == UCLASS_RKNAND ||
			 ...
			 * - avoid alias id on different device between U-Boot and kernel
			 */
...
/**
 * @brief Bind a device with driver data
 *
 * @param parent Parent device
 * @param drv Driver
 * @param name Device name
...
/**
 * @brief Bind a device by name
 *
 * @param parent Parent device
 * @param pre_reloc_only Pre-relocation only flag
...
/**
 * @brief Allocate private data
 *
 * @param size Size of the private data
 * @param flags Flags
 * @return Pointer to the allocated private data, or NULL on error
 */
...
/**
 * @brief Get platform data of a device
 *
 * @param dev Device
 * @return Pointer to the platform data, or NULL if not found
 */
...
/**
 * @brief Get parent platform data of a device
 *
 * @param dev Device
 * @return Pointer to the parent platform data, or NULL if not found
 */
...
/**
 * @brief Get uclass platform data of a device
 *
 * @param dev Device
 * @return Pointer to the uclass platform data, or NULL if not found
 */
...
/**
 * @brief Get private data of a device
 *
 * @param dev Device
 * @return Pointer to the private data, or NULL if not found
 */
...
/**
 * @brief Get uclass private data of a device
 *
 * @param dev Device
 * @return Pointer to the uclass private data, or NULL if not found
 */
...
/**
 * @brief Get parent private data of a device
 *
 * @param dev Device
 * @return Pointer to the parent private data, or NULL if not found
 */
...
/**
 * @brief Get child device by index
 *
 * @param parent Parent device
 * @param index Index of the child
 * @param devp Pointer to store the child device
 * @return 0 on success, otherwise error
 */
...
/**
 * @brief Find child device by sequence
 *
 * @param parent Parent device
...
/**
 * @brief Get child device by sequence
 *
 * @param parent Parent device
 * @param seq Sequence
 * @param devp Pointer to store the child device
...
/**
 * @brief Find child device by device tree offset
 *
 * @param parent Parent device
 * @param of_offset Device tree offset
 * @param devp Pointer to store the child device
...
/**
 * @brief Get child device by device tree offset
 *
 * @param parent Parent device
 * @param node Device tree node
 * @param devp Pointer to store the child device
...
/**
 * @brief Find global device by device tree offset
 *
 * @param parent Parent device
 * @param of_offset Device tree offset
 * @return Pointer to the found device, or NULL if not found
 */
...
/**
 * @brief Get global device by device tree offset
 *
 * @param of_offset Device tree offset
...
/**
 * @brief Find the first child device
 *
 * @param parent Parent device
 * @param devp Pointer to store the first child device
 * @return 0 on success, otherwise error
 */
...
/**
 * @brief Find the next child device
 *
 * @param devp Pointer to store the next child device
 * @return 0 on success, otherwise error
 */
 ...
 * @return Pointer to the parent device
 */
...
/**
 * @brief Get driver data of a device
 *
 * @param dev Device
 * @return Driver data
 */
...
/**
 * @brief Get driver operations of a device
 *
 * @param dev Device
 * @return Pointer to the driver operations, or NULL if not found
 */
...
/**
 * @brief Get uclass ID of a device
 *
 * @param dev Device
 * @return Uclass ID
 */
...
/**
 * @brief Get uclass name of a device
 *
 * @param dev Device
 ...
 *
 * @param dev Device
 * @return true if the device has children, otherwise false
 */
...
/**
 * @brief Check if a device has active children
 *
 * @param dev Device
 * @return true if the device has active children, otherwise false
 */
...
/**
 * @brief Check if a device is the last sibling
 *
 * @param dev Device
 * @return true if the device is the last sibling, otherwise false
 */
...
/**
 * @brief Set the name of a device as allocated
 *
 * @param dev Device
 */
...
/**
 * @brief Set the name of a device
 *
 * @param dev Device
 * @param name Device name
 * @return 0 on success, otherwise error
 ...
 * @return true if the device is compatible, otherwise false
 */
...
/**
 * @brief Check if the machine is compatible
 *
 * @param compat Compatibility string
 * @return true if the machine is compatible, otherwise false
 */
