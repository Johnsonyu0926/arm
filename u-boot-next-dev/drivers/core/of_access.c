...
/**
 * @brief Get the number of address cells for a device node
 *
...
/**
 * @brief Get the number of size cells for a device node
 *
 * @param np Device node
...
/**
 * @brief Get the number of address cells for a device node (simple version)
 *
 * @param np Device node
 * @return Number of address cells
 */
...
/**
 * @brief Get the number of size cells for a device node (simple version)
 *
 * @param np Device node
 * @return Number of size cells
 */
...
/**
 * @brief Find a property in a device node
 *
 * @param np Device node
...
/**
 * @brief Find all nodes in the device tree
 *
 * @param prev Previous node
 * @return Pointer to the next node, or NULL if no more nodes
 */
...
/**
 * @brief Get a property from a device node
 *
 * @param np Device node
 * @param name Property name
 * @param lenp Pointer to store the length of the property
...
/**
 * @brief Get the first property of a device node
 *
 * @param np Device node
 * @return Pointer to the first property, or NULL if no properties
 */
...
/**
 * @brief Get the next property of a device node
 *
 * @param np Device node
 * @param property Current property
 * @return Pointer to the next property, or NULL if no more properties
 */
...
/**
 * @brief Get a property value by property pointer
 *
 * @param np Device node
...
/**
 * @brief Get the next string in a property
 *
 * @param prop Property
 * @param cur Current string
 * @return Pointer to the next string, or NULL if no more strings
 */
...
/**
 * @brief Check if a device is compatible
 *
 * @param device Device node
 * @param compat Compatibility string
 * @param type Type string
 * @param name Name string
 * @return Compatibility score, or 0 if not compatible
 */
...
/**
 * @brief Find a node by its path and options
 *
 * @param path Path to the node
 * @param opts Pointer to store the options
 * @return Pointer to the found node, or NULL if not found
 */
...
/**
 * @brief Find a compatible node
 *
 * @param from Starting node
 * @param type Type string
 * @param compatible Compatibility string
 * @return Pointer to the found node, or NULL if not found
 */
...
/**
 * @brief Find a node by its phandle
 *
...
struct device_node *of_find_node_by_phandle(phandle handle)
{
	...
	/* If not found in kernel fdt, traverse u-boot fdt */
	if (!np) {
...
/**
 * @brief Find a property value of a given size
 *
 * @param np Device node
 * @param propname Property name
 * @param len Requested length of the property value
 * @return Pointer to the property value, or error pointer on failure
 */
...
/**
 * @brief Read a 32-bit integer from a property
 *
 * @param np Device node
 * @param propname Property name
 * @param outp Pointer to store the value
...
/**
 * @brief Read a 64-bit integer from a property
 *
 * @param np Device node
 * @param propname Property name
...
/**
 * @brief Read an array of 32-bit integers from a property
 *
 * @param np Device node
 * @param propname Property name
...
/**
 * @brief Write an array of 32-bit integers to a property
 *
 * @param np Device node
 * @param propname Property name
...
/**
 * @brief Match a string in a property
 *
 * @param np Device node
 * @param propname Property name
 * @param string String to match
 * @return Index of the matched string, or error code on failure
 */
...
/**
 * @brief Utility helper for parsing string properties
 *
 * @param np Device node
 * @param propname Property name
 * @param out_strs Output array of string pointers
 * @param sz Number of array elements to read
 * @param skip Number of strings to skip over at beginning of list
 * @return Number of strings read, or error code on failure
 */
...
/**
 * @brief Parse phandle with arguments
 *
 * @param np Device node
 * @param list_name List name
 * @param cells_name Cells name
 * @param cell_count Cell count
 * @param index Index
 * @param out_args Pointer to store the parsed arguments
 * @return 0 on success, otherwise error
 */
...
/**
 * @brief Parse a phandle
 *
 * @param np Device node
 * @param phandle_name Phandle name
 * @param index Index
 * @return Pointer to the parsed node, or NULL if not found
 */
...
/**
 * @brief Count the number of phandles with arguments
 *
 * @param np Device node
 * @param list_name List name
 * @param cells_name Cells name
 * @return Number of phandles, or error code on failure
 */
...
/**
 * @brief Add an alias property
 *
 * @param ap Alias property
 * @param np Device node
 * @param id Index value
 * @param stem Alias string without the index
 * @param stem_len Length of the alias string
 */
...
/**
 * @brief Get the ID of an alias
 *
 * @param np Device node
 * @param stem Alias string without the index
 * @return Alias ID, or error code on failure
 */
