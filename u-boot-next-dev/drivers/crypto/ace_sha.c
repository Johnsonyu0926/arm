// u-boot-next-dev/drivers/crypto/ace_sha.c
...
/**
 * @brief Computes hash value of input buffer using ACE
 *
 * @param pbuf Pointer to the input buffer
 * @param buf_len Byte length of input buffer
...
/**
 * @brief Compute SHA256 hash using hardware acceleration
 *
 * @param pbuf Pointer to the input buffer
 * @param buf_len Byte length of input buffer
 * @param pout Pointer to the output buffer
...
/**
 * @brief Compute SHA1 hash using hardware acceleration
 *
 * @param pbuf Pointer to the input buffer
 * @param buf_len Byte length of input buffer
 * @param pout Pointer to the output buffer
...
/**
 * @brief Seed the hardware random number generator
 *
...
/**
 * @brief Generate a random number using hardware RNG
 *
...
/**
 * @brief Generate a random number using hardware RNG with a seed
 *
 * @param seedp Pointer to the seed value
 * @return Random number
 */
