// u-boot-next-dev/drivers/crypto/rockchip/crypto_v1.c
...
/**
 * @brief Get the capabilities of the Rockchip crypto device
 *
...
/**
 * @brief Perform direct hash calculation
 *
 * @param hw_data Pointer to the hardware data
 * @param data Pointer to the input data
 * @param data_len Length of the input data
 * @param started_flag Pointer to the started flag
...
/**
 * @brief Parse device tree data to platform data
 *
 * @param dev Pointer to the device
 * @return 0 on success, negative error code on failure
 */
...
/**
 * @brief Probe the Rockchip crypto device
 *
 * @param dev Pointer to the device
 * @return 0 on success, negative error code on failure
 */
