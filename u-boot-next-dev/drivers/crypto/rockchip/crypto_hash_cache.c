// u-boot-next-dev/drivers/crypto/rockchip/crypto_hash_cache.c
...
/**
 * @brief Calculate hash cache
 *
 * @param hash_cache Pointer to the hash cache structure
 * @param data Pointer to the input data
 * @param data_len Length of the input data
 * @param is_last Flag indicating if this is the last chunk
...
/**
 * @brief Allocate hash cache
 *
 * @param direct_calc Direct calculation function
 * @param user_data User data
 * @param total Total size
 * @param data_align Data alignment
 * @param len_align Length alignment
 * @return Pointer to the allocated hash cache structure, or NULL on failure
 */
