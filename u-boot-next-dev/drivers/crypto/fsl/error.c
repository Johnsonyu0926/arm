...
/**
 * @brief Report condition code status
 *
 * @param status Status code
 * @param error Error message
 */
...
/**
 * @brief Report CAAM job ring status
 *
 * @param status Status code
 */
