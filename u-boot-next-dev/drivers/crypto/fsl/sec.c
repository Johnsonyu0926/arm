...
/**
 * @brief Fix up the crypto node properties for SEC 2.x/3.x
 *
 * @param blob Pointer to the device tree blob
 * @param sec_rev SEC revision
 */
...
/**
 * @brief Fix up the crypto node properties for SEC4
 *
 * @param blob Pointer to the device tree blob
 * @param era CAAM era
 */
