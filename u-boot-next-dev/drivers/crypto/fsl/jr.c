...
/**
 * @brief Start job ring 0
 *
 * @param sec_idx SEC index
 */
...
/**
 * @brief Initialize job ring registers
 *
 * @param sec_idx SEC index
 */
...
/**
 * @brief Clean up job ring software state
 *
 * @param sec_idx SEC index
 * @return 0 on success
 */
...
/**
 * @brief Enqueue a job descriptor
 *
 * @param desc_addr Pointer to the descriptor
	       ...
	       void *arg, uint8_t sec_idx)
{
	 ...
	 * The 32 bit high and low part of the address will
...
/**
 * @brief Dequeue a job descriptor
 *
 * @param sec_idx SEC index
 * @return 0 on success, negative error code on failure
 */
...
/**
 * @brief Callback function for descriptor completion
 *
...
/**
 * @brief Run a descriptor on the job ring with specified SEC index
 *
...
/**
 * @brief Reset job ring for specified SEC index
 *
 * @param sec_idx SEC index
 * @return 0 on success, negative error code on failure
 */
...
/**
 * @brief Reset SEC for specified SEC index
 *
 * @param sec_idx SEC index
 * @return 0 on success, negative error code on failure
 */
...
/**
 * @brief Get RNG version ID
 *
 * @param sec_idx SEC index
 * @return RNG version ID
 */
...
/**
 * @brief Kick TRNG to generate entropy
 *
...
/**
 * @brief Initialize SEC for specified SEC index
 *
 * @param sec_idx SEC index
 * @return 0 on success, negative error code on failure
 */
