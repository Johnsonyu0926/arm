...
/**
 * @brief Secure memory run command
 *
 * @param sec_mem_cmd Secure memory command register
 * @return Secure memory command status register
 */
 ...
 *
 * @param page_num Number of the page to allocate
 * @param partition_num Number of the partition to allocate
 ...
 * @param dek_blob Reference where to store the blob
