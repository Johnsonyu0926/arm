...
/**
 * @brief Load the update file via TFTP
 *
 * @param filename Name of the update file
 * @param msec_max Maximum timeout in milliseconds
 * @param cnt_max Maximum retry count
...
#ifdef CONFIG_MTD_NOR_FLASH
/**
 * @brief Protect or unprotect flash sectors
 *
 * @param prot Protection flag (1 to protect, 0 to unprotect)
 * @param addr_first First address
 * @param addr_last Last address
 * @return 0 on success, 1 on failure
 */
...
/**
 * @brief Update the flash memory with the new firmware
 *
 * @param addr_source Source address of the new firmware
 * @param addr_first First address in flash to update
 * @param size Size of the new firmware
 * @return 0 on success, 1 on failure
 */
...
/**
 * @brief Get parameters from the FIT image
 *
 * @param fit Pointer to the FIT image
 * @param noffset Node offset in the FIT image
 * @param addr Pointer to store the address
 * @param fladdr Pointer to store the flash address
...
/**
 * @brief Perform the TFTP update
 *
 * @param addr Address of the update file
 * @param interface Network interface
 * @param devstring Device string
