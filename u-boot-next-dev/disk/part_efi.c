...
/**
 * @brief EFI version of crc32 function
 *
...
/**
 * @brief Get the disk GUID
 *
 * @param dev_desc Block device descriptor
 * @param guid Buffer to store the GUID
...
/**
 * @brief Print EFI partition information
 *
 * @param dev_desc Block device descriptor
 */
...
/**
 * @brief Get partition information for EFI
 *
 * @param dev_desc Block device descriptor
 * @param part Partition number
 * @param info Pointer to disk partition information structure
 * @return 0 on success, otherwise error
 */
...
/**
 * @brief Set the EFI protective MBR
 *
 * @param dev_desc Block device descriptor
 * @return 0 on success, otherwise error
 */
...
/**
 * @brief Write GPT table to the device
 *
 * @param dev_desc Block device descriptor
 * @param gpt_h GPT header
 * @param gpt_e GPT entries
 * @return 0 on success, otherwise error
 */
...
/**
 * @brief Fill GPT partition entries
 *
 * @param dev_desc Block device descriptor
 * @param gpt_h GPT header
 * @param gpt_e GPT entries
...
/**
 * @brief Get partition entries offset
 *
 * @param dev_desc Block device descriptor
 * @return Offset in blocks
 */
static uint32_t partition_entries_offset(struct blk_desc *dev_desc)
{
	...
	/*
	 * Allow the offset of the first partition entries (in bytes
...
/**
 * @brief Fill GPT header
 *
 * @param dev_desc Block device descriptor
 * @param gpt_h GPT header
 * @param str_guid Disk GUID
...
/**
 * @brief Restore GPT partition table
 *
 * @param dev_desc Block device descriptor
...
/**
 * @brief Convert u16 string to char string
 *
 * TODO: this conversion only supports ANSI characters
 *
 * @param s Target buffer
 * @param es u16 string to be converted
 * @param n Size of target buffer
 */
...
/**
 * @brief Verify GPT headers
 *
 * @param dev_desc Block device descriptor
 * @param gpt_head GPT header
 * @param gpt_pte GPT entries
 * @return 0 on success, otherwise error
 */
...
/**
 * @brief Check if the buffer contains a valid GPT
 *
 * @param dev_desc Block device descriptor
 * @param buf Buffer containing the GPT
 * @return 0 on success, otherwise error
 */
...
/**
 * @brief Write MBR and GPT partitions to the device
 *
 * @param dev_desc Block device descriptor
 * @param buf Buffer containing the MBR and GPT
 * @return 0 on success, otherwise error
 */
 ...
 */
/**
 * @brief Check for EFI partition signature
 *
 * @param part Partition
 * @return 1 if EFI GPT partition type is found, otherwise 0
 */
static int pmbr_part_valid(struct partition *part)
{
...
/**
 * @brief Test Protective MBR for validity
 *
 * @param mbr Legacy MBR
 * @return 1 if PMBR is valid, otherwise 0
 */
static int is_pmbr_valid(legacy_mbr * mbr)
{
	int i = 0;
...
/**
 * @brief Tests one GPT header and PTEs for validity
 *
 * @param dev_desc Block device descriptor
 * @param lba Logical block address of the GPT header to test
 * @param pgpt_head GPT header pointer, filled on return
 * @param pgpt_pte PTEs pointer, filled on return
...
/**
 * @brief Reads partition entries from disk
 *
 * @param dev_desc Block device descriptor
 * @param pgpt_head GPT header
...
/**
 * @brief Validates a single Partition Table Entry
 *
 *
 * @param pte Pointer to a single Partition Table Entry
 * @return 1 if valid, 0 on error
 */
static int is_pte_valid(gpt_entry * pte)
{
