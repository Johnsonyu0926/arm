...
typedef struct iso_boot_rec {
    unsigned char desctype;          /* type of Volume descriptor: 0 = boot record, 1 = primary, 2 = Supplement, 3 = volume part 0xff terminator */
...
typedef struct iso_pri_rec {
    ...
    unsigned char filestruc_ver;     /* file structure version */
} iso_pri_rec_t;
...
typedef struct iso_header_entry {
    ...
    char id_str[0x1C];               /* Ident String of section */
} iso_header_entry_t;
