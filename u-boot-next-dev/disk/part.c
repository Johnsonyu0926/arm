...
/**
 * @brief Lookup partition driver by type
 *
 * @param dev_desc Block device descriptor
 * @return Pointer to the partition driver, or NULL if not found
 */
...
/**
 * @brief Get block device with hardware partition
 *
 * @param ifname Interface name
 * @param dev Device number
 * @param hwpart Hardware partition number
 * @return Pointer to the block device descriptor, or NULL if not found
 */
...
/**
 * @brief Overflowless variant of (block_count * mul_by / div_by)
 *
 * @param block_count Number of blocks
 * @param mul_by Multiplier
 * @param div_by Divider
 * @return Result of the multiplication and division
 */
 ...
 *
 * @param dev_desc Block device descriptor
 * @return Partition type name, or NULL if not found
 */
...
/**
 * @brief Get information for the whole disk
 *
 * @param dev_desc Block device descriptor
 * @param info Pointer to disk partition information structure
 * @return 0 on success, otherwise error
...
/**
 * @brief Get block device by string
 *
 * @param ifname Interface name
 * @param dev_hwpart_str Device and hardware partition string
 * @param dev_desc Pointer to block device descriptor
 * @return Device number on success, otherwise error
 */
...
/**
 * @brief Get block device and partition by string
 *
 * @param ifname Interface name
 * @param dev_part_str Device and partition string
 * @param dev_desc Pointer to block device descriptor
 * @param info Pointer to disk partition information structure
 * @param allow_whole_dev Allow whole device flag
 * @return Partition number on success, otherwise error
 */
...
/**
 * @brief Get partition information by name with option
 *
 * @param dev_desc Block device descriptor
...
/**
 * @brief Get partition information by name in strict mode
 *
 * @param dev_desc Block device descriptor
 * @param name Partition name
 * @param info Pointer to disk partition information structure
...
/**
 * @brief Set generic partition name
 *
 * @param dev_desc Block device descriptor
 * @param part_num Partition number
 * @param name Buffer to store the partition name
 */
