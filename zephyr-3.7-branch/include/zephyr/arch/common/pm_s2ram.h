// zephyr-3.7-branch/include/zephyr/arch/common/pm_s2ram.h
 ...
 *
 * This function is passed as an argument and called by @ref arch_pm_s2ram_suspend
 ...
 * of restoring the system to a fully operational state before returning.
 *
 ...
 *
 * The CPU context is usually the minimum set of CPU registers whose content
 ...
 *
 * This function is called when the system state is stored to RAM, just before going to system
 * off.
 *
 * The default implementation sets a magic word in RAM. CONFIG_PM_S2RAM_CUSTOM_MARKING
 ...
 *
 * This function is used to determine if resuming after suspend-to-RAM shall be performed
 * or standard boot code shall be executed.
 *
 * The default implementation checks a magic word in RAM. CONFIG_PM_S2RAM_CUSTOM_MARKING
 * allows custom implementation.
 *
